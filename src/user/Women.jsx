  ...
  useEffect(() => {
    const fetchWomensWatches = async () => {
      try {
        ...
        const womensWatches = allProducts.filter(
          (product) => product.category?.toLowerCase() === "women"
        );

        setProducts(womensWatches);
      } catch (err) {
  ...
  return (
    <div>
      <div className="px-4 py-8 max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8">Women's Watches</h1>
